...
class customerCreate extends Component {
    ...
    saveCustomer = (e)=> {
        e.preventDefault();
        let customer = {firstName: this.state.firstName, lastName: this.state.lastName, nic: this.state.nic,
        address: this.state.address , phoneNo: this.state.phoneNo, email: this.state.email, vehicleRegNo: this.state.vehicleRegNo};
    ...
    render() {
        return (
            <div>
                 ...
                 <h3 className="text-center">Add Customer</h3><br/>
                     <div className={styles.vcard}>
                         <form>
                            ...
                            <div className= {styles.inputs} type="">
                                <label>NIC:</label>
                            ...
                            <div className= {styles.inputs}>
                             ...
                             <div className={styles.buttons}>
                                <button className="btn btn-secondary" onClick={this.saveCustomer}>Save</button>
