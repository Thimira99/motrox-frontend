...
class UpdateOrder extends Component {
    ...
    updateOrder = (e) => { 
        e.preventDefault();
        let order = {date: this.state.date, supplier: this.state.supplier, itemCode: this.state.itemCode, itemName: this.state.itemName, quantity: this.state.quantity, price: this.state.price, totalPrice: this.state.totalPrice };
                ...
                <div className = "container">
                    <div className = "row">
                        <div className = "card col-md-6 offset-md-3 offset-md-3">
                            <h3 className = "text-center">Update Order Form</h3>
